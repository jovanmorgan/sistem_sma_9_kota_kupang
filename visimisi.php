...
<body>
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            ...
                            <li><a class="dropdown-item active" href="visimisi">Visi misi</a></li>
                        </ul>
                    </li>
                    <li class="nav-item">
    ...
    <div id="konten2" class="container-xxl mt-2 mb-1 bg-light">
        <h2 class="garistitik" style="font-size: 25px; font-weight: bolder; text-align: center; padding-top: 20px;">
            -------------------</h2>
        <div class="row bagian2">
            <div class="col-md-6">
                <!-- Teks di kiri -->
                <div class="left-content">
                    <h2 style="font-size: 25px; padding-top: 20px; text-align: center;">Visi</h2>
                    <p style="text-align: justify;">
                        "Menjadi pusat pendidikan inklusif terkemuka yang menghasilkan individu dengan potensi terbaik,
                        mampu berintegrasi dalam masyarakat, dan menjadi pemimpin masa depan dalam bidangnya."
                    </p>
                </div>
            </div>
            <div class="col-md-6">
                ...
                <div class="right-content">
                    <h2 style="font-size: 25px; padding-top: 10px; text-align: center;">Misi</h2>
                    <p style="text-align: justify;">
                    <ul>
                        <li>Memberikan pendidikan inklusif berkualitas bagi siswa berkebutuhan khusus.</li>
                        <li>Melibatkan orang tua dan masyarakat dalam mendukung perkembangan siswa.</li>
                        <li>Mengembangkan kemitraan untuk menyediakan peluang pendidikan dan pekerjaan bagi lulusan.
                        </li>
                        <li>Terus meningkatkan program pendidikan dan sarana prasarana untuk pelayanan pendidikan yang
                            berkualitas.</li>
                    </ul>
                    </p>
                </div>

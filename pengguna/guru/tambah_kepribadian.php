...
<body translate="no" class="white-content">
    <div class="wrapper">
        ...
        <div class="main-panel">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_tambah" action="kepribadian/tambah.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="kerajinan" name="kerajinan" required>
                                        <option value="" selected>Silakan Pilih kepribadian Kerajinan</option>
                                        <option value="91-100 (A)">90-100 (A)</option>
                                        <option value="81-90 (B)">81-90 (B)</option>
                                        <option value="71-80 (C)">71-80 (C)</option>
                                        <option value="61-70 (D)">61-70 (D)</option>
                                    </select>
                                </div>
                                <div class="form-group">
                                    <label for="kerapian">Kerapian :</label>
                                    <select class="form-control" id="kerapian" name="kerapian" required>
                                        <option value="" selected>Silakan Pilih kepribadian Kerapian</option>
                                        <option value="91-100 (A)">90-100 (A)</option>
                                        <option value="81-90 (B)">81-90 (B)</option>
                                        <option value="71-80 (C)">71-80 (C)</option>
                                        <option value="61-70 (D)">61-70 (D)</option>
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="keterampilan" name="keterampilan" required>
                                        <option value="" selected>Silakan Pilih kepribadian Keterampilan</option>
                                        <option value="91-100 (A)">90-100 (A)</option>
                                        <option value="81-90 (B)">81-90 (B)</option>
                                        <option value="71-80 (C)">71-80 (C)</option>
                                        <option value="61-70 (D)">61-70 (D)</option>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_edit" action="kepribadian/edit.php" method="POST" enctype="multipart/form-data">
                                <!-- Menambahkan input tersembunyi untuk menyimpan id_video saat mengedit -->
                                <input type="hidden" id="id_kepribadian-edit" name="id_kepribadian">
                                <input type="hidden" id="id_siswa" name="id_siswa" value="<?php echo $id_siswa; ?>">
                                <input type="hidden" id="id_tahun_ajar" name="id_tahun_ajar" value="<?php echo $id_tahun_ajar; ?>">
                                <input type="hidden" id="semester" name="semester" value="<?php echo $semester; ?>">
                                <div class="form-group">
                                    <label for="kerajinan">Kerajinan :</label>
                                    <select class="form-control" id="kerajinan-edit" name="kerajinan" required>
                                        <option value="" selected>Silakan Pilih kepribadian Kerajinan</option>
                                        <option value="91-100 (A)">90-100 (A)</option>
                                        <option value="81-90 (B)">81-90 (B)</option>
                                        <option value="71-80 (C)">71-80 (C)</option>
                                ...
                                <div class="form-group">
                                    <label for="kerapian">Kerapian :</label>
                                    <select class="form-control" id="kerapian-edit" name="kerapian" required>
                                        <option value="" selected>Silakan Pilih kepribadian Kerapian</option>
                                        <option value="91-100 (A)">90-100 (A)</option>
                                        <option value="81-90 (B)">81-90 (B)</option>
                                        <option value="71-80 (C)">71-80 (C)</option>
                                ...
                                <div class="form-group">
                                    <label for="keterampilan">Keterampilan :</label>
                                    <select class="form-control" id="keterampilan-edit" name="keterampilan" required>
                                        <option value="" selected>Silakan Pilih kepribadian Keterampilan</option>
                                        <option value="91-100 (A)">90-100 (A)</option>
                                        <option value="81-90 (B)">81-90 (B)</option>
                                        <option value="71-80 (C)">71-80 (C)</option>
            ...
            <script>
                function openEditModal(id_kepribadian, kerajinan, kerapian, keterampilan) {
                    // Isi data ke dalam form edit
                    document.getElementById('id_kepribadian-edit').value = id_kepribadian;
                    document.getElementById('kerajinan-edit').value = kerajinan;
                    document.getElementById('kerapian-edit').value = kerapian;
                    document.getElementById('keterampilan-edit').value = keterampilan;
                                ...
                                <div class="places-buttons">
                                    <div class="row mb-3">
                                        <div class="col-md-12 ml-auto mr-auto text-center mt-3">
                                            <h2 class="card-title-custom">Data Kepribadian
                                            </h2>
                                            <p class="category">Klik untuk menambah data atau kembali</p>
                                            <div class="col-lg-8 ml-auto mr-auto">
                                                <div class="row justify-content-center align-items-center">
                                                    <div class="col-md-4">
                                                        <a href="guru_data_kepribadian.php?
                                                        \>&id_kelas=<?php echo $id_kelas; ?>&jenjang=<?php echo $jenjang; ?>&semester=<?php echo $semester; ?>&id_siswa=<?php echo $id_siswa; ?>&id_tahun_ajar=<?php echo $id_tahun_ajar; ?>" class=" btn btn-secondary btn-block">Kembali</a>
                                                    </div>
                                                    <div class="col-md-4">
                                        ...
                                        <div class="col-md-3 ml-auto mr-auto text-center">
                                            ...
                                            <div class="select-custom">
                                                ...
                                                <input type="text" id="tahun_ajar" class="form-control" value="<?php echo $tahun_ajar; ?>" disabled>
                                            </div>
                                        </div>
                                        <div class="col-md-3 ml-auto mr-auto text-center">
                                        ...
                                        <script>
                                            ...
                                            function reloadPageWithSelection() {
                                                ...
                                                var id_tahun_ajar = document.getElementById('tahun_ajar')
                                                    .value; // Ambil kepribadian tahun ajaran yang dipilih
                                                ...
                                                window.location.href =
                                                    `tambah_kepribadian.php?id_mapel=<?php echo $id_mapel; ?>&id_kelas=<?php echo $id_kelas; ?>&jenjang=<?php echo $jenjang; ?>&semester=${semester}&type_nilai=<?php echo $type_nilai; ?>&id_tahun_ajar=<?php echo $id_tahun_ajar; ?>&id_siswa=${id_siswa}`;
                                            }
                                        </script>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.getElementById('form_tambah').addEventListener('submit', function(event) {
                ...
                xhr.open('POST', 'kepribadian/tambah.php', true);
                xhr.onload = function() {
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.getElementById('form_edit').addEventListener('submit', function(event) {
                ...
                var xhr = new XMLHttpRequest();
                xhr.open('POST', 'kepribadian/edit.php', true);
                xhr.onload = function() {
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        ...
                        xhr.open('POST', 'kepribadian/hapus.php', true);
        ...
        function loadTable() {
            ...
            xhrTable.open('GET',
                'kepribadian/load_table.php?id_mapel=<?php echo $id_mapel; ?>&id_kelas=<?php echo $id_kelas; ?>&jenjang=<?php echo $jenjang; ?>&semester=<?php echo $semester; ?>&type_nilai=<?php echo $type_nilai; ?>&id_siswa=<?php echo $id_siswa; ?>&id_tahun_ajar=<?php echo $id_tahun_ajar; ?>',
                true);
            xhrTable.send();
        }
    </script>

...
$select_query = "SELECT fp FROM guru WHERE id_guru = '$id_guru'";
...
// Update nama gambar di tabel guru berdasarkan id_guru
$update_query = "UPDATE guru SET fp = '$filename' WHERE id_guru = '$id_guru'";
$update_result = mysqli_query($koneksi, $update_query);

if ($update_result) {
    // Berhasil menyimpan gambar dan update nama gambar di tabel guru

            ...
            <div class="content">
                <div class="row">
                                ...
                                <div class="places-buttons">
                                    <div class="row">
                                        <div class="col-md-6 ml-auto mr-auto text-center">
                                            ...
                                            <p class="category-custom">Clik Card mata pelajaran untuk mengisi nilai</p>
                                            <hr>
                    ...
                    <div class="col-lg-4 col-md-6">
                        <div class="card card-custom kotak_keren"
                            onclick="detailData('<?php echo $mapel['id_mapel']; ?>')">

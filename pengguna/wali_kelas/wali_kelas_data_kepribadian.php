                                ...
                                <div class="places-buttons">
                                    <div class="row mb-3">
                                        <div class="col-md-12 ml-auto mr-auto text-center">
                                            ...
                                            <p class="category-custom">Click card mata pelajaran untuk mengisi
                                                kepribadian
                                            </p>
                                            <hr>
                                        </div>
                                        ...
                                        <tbody>
                                            ...
                                            if ($result && mysqli_num_rows($result) > 0) {
                                                ...
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    echo "<a href='#' onclick='checkAndRedirect(\"{$id_kelas}\", \"{$jenjang}\", \"{$semester}\", \"{$row['id_siswa']}\", \"{$id_tahun_ajar}\")' class='btn btn-primary btn-sm'>Lihat Kepribadian</a>";
                                                    echo "</td>";
                                                    echo "</tr>";
    ...
    <script>
        ...
        function reloadPageWithSelection() {
            ...
            window.location.href =
                `wali_kelas_data_kepribadian.php?id_kelas=${id_kelas}&jenjang=${jenjang}&semester=${semester}&type_nilai=<?php echo $type_nilai; ?>&id_tahun_ajar=${id_tahun_ajar}`;
        }
        ...
        function checkAndRedirect(id_kelas, jenjang, semester, id_siswa, id_tahun_ajar) {
            ...
            if (!tahun_ajar) {
                ...
                // Redirect to tambah_kepribadian page if all fields are selected
                var url =
                    `tambah_kepribadian.php?id_kelas=${id_kelas}&jenjang=${jenjang}&semester=${semester}&id_siswa=${id_siswa}&id_tahun_ajar=${id_tahun_ajar}`;

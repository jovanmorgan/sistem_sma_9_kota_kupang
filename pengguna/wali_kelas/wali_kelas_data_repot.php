...
<body translate="no" class="white-content">
            ...
            <nav class="navbar navbar-expand-lg navbar-absolute navbar-transparent">
                <div class="container-fluid">
                    <div class="navbar-wrapper">
                        ...
                        <a class="navbar-brand" href="javascript:void(0)">Dashboard wali_kelas</a>
                    </div>
    ...
    function reloadPageWithSelection() {
        ...
        window.location.href =
            `wali_kelas_data_repot.php?id_kelas=${id_kelas}&jenjang=${jenjang}&semester=${semester}&type_nilai=<?php echo $type_nilai; ?>&id_tahun_ajar=${id_tahun_ajar}`;
    }

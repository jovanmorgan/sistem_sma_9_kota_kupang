                                        ...
                                        <div class="col-md-12 ml-auto mr-auto text-center mt-3">
                                            ...
                                            <div class="col-lg-8 ml-auto mr-auto">
                                                <div class="row justify-content-center align-items-center">
                                                    <div class="col-md-4">
                                                        <a href="wali_kelas_data_kepribadian.php?
                                                        \>&id_kelas=<?php echo $id_kelas; ?>&jenjang=<?php echo $jenjang; ?>&semester=<?php echo $semester; ?>&id_siswa=<?php echo $id_siswa; ?>&id_tahun_ajar=<?php echo $id_tahun_ajar; ?>"

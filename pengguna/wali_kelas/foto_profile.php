                                ...
                                <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                                    <div class="photo">
                                        ...
                                        if (isset($_SESSION['id_wali_kelas'])) {
                                            ...
                                            // Query SQL untuk mengambil data wali_kelas dan nama guru berdasarkan id_wali_kelas dari session
                                            $query = "
        SELECT wali_kelas.*, guru.nama AS nama_guru 
        FROM wali_kelas 
        JOIN guru ON wali_kelas.id_guru = guru.id_guru 
        WHERE wali_kelas.id_wali_kelas = '$id_wali_kelas'
    ";
                                        ...
                                        ?>
                                                    ...
                                                    <?php endif; ?>
                                                    <h5 class="title"><?php echo $wali_kelas['username']; ?></h5>
                                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="author">
                                    ...
                                    <a href="javascript:void(0)" onclick="document.getElementById('editFotoProfile').click()">
                                        ...
                                        <?php endif; ?>
                                        <h5 class="title"><?php echo $wali_kelas['nama_guru']; ?></h5>
                                    </a>
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form id="editDataFp">
                                    <div class="row">
                                        <input type="hidden" class="form-control" name="id_wali_kelas" id="id_wali_kelas" value="<?php echo $wali_kelas['id_wali_kelas']; ?>">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Nama</label>
                                                <input type="text" class="form-control" placeholder="Nama" name="nama" id="nama" value="<?php echo $wali_kelas['nama_guru']; ?>" disabled>
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Username</label>
                                                <input type="text" class="form-control" placeholder="Username" name="username" id="username" value="<?php echo $wali_kelas['username']; ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Password</label>
                                                <input type="text" class="form-control" placeholder="Password" name="password" id="password" value="<?php echo $wali_kelas['password']; ?>">
                                            </div>
                                        </div>
                                    </div>

...
<body class="white-content" translate="no">
    <div class="wrapper">
        ...
        <div class="main-panel">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_tambah" action="absensi1/tambah.php" method="POST"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_edit" action="absensi1/edit.php" method="POST" enctype="multipart/form-data">
                                ...
                                <script>
                                function openEditModal(id_absensi1, id_kelas, id_mapel, jenjang) {
                                ...
                                <div class="table-responsive">
                                    <table class="table tablesorter " id="dataTable">
                                        ...
                                        <tbody>
                                            ...
                                            // Ambil data id_kelas dan jenjang dari tabel siswa berdasarkan id_siswa di sesi
                                            $query_siswa = "SELECT id_kelas, jenjang FROM siswa WHERE id_siswa = '$id_siswa'";
                                            ...
                                            // Query SQL untuk mengambil data dari tabel absensi1 dengan filter id_kelas dan jenjang yang sama
          ...
          WHERE absensi1.id_kelas = '$id_kelas' AND absensi1.jenjang = '$jenjang'";

                                            // Jika ada kata kunci pencarian, tambahkan klausa WHERE untuk mencocokkan
                                            if (!empty($search_query)) {
                                                $query .= " AND (kelas.kelas LIKE '%$search_query%' OR mapel.nama_mapel LIKE '%$search_query%' OR absensi1.jenjang LIKE '%$search_query%')";
                                            }
                ...
                <a href='siswa_data_absensi_detail?id_absensi=" . $row['id_absensi1'] . "' class='btn btn-info btn-sm'>Detail</a>
                </td>";
                                                    echo "</tr>";
    ...
    document.addEventListener('DOMContentLoaded', function() {
        document.getElementById('form_tambah').addEventListener('submit', function(event) {
            ...
            xhr.open('POST', 'absensi1/tambah.php', true);
            xhr.onload = function() {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        document.getElementById('form_edit').addEventListener('submit', function(event) {
            ...
            var xhr = new XMLHttpRequest();
            xhr.open('POST', 'absensi1/edit.php', true);
            xhr.onload = function() {
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    xhr.open('POST', 'absensi1/hapus.php', true);
    ...
    function loadTable() {
        ...
        xhrTable.open('GET', 'absensi1/load_table.php', true);
        xhrTable.send();
    }
    </script>

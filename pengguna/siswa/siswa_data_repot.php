...
<body translate="no" class="white-content">
    <div class="wrapper">
        ...
        <div class="main-panel">
            ...
            // Query SQL untuk menampilkan data siswa berdasarkan kelas, jenjang, id_tahun_ajar, dan id_siswa dari sesi
          ...
          WHERE siswa.id_siswa = '$id_siswa'";
            ...
            if (!empty($id_kelas) && !empty($jenjang) && !empty($id_tahun_ajar)) {
                $query .= " AND siswa.id_kelas = '$id_kelas' AND siswa.jenjang = '$jenjang' AND siswa.id_tahun_ajar = '$id_tahun_ajar'";
            }
                                ...
                                <div class="places-buttons">
                                    <div class="row mb-3">
                                        <div class="col-md-12 ml-auto mr-auto text-center">
                                            <h2 class="card-title-custom">Data Raport
                                            </h2>
                                            <p class="category-custom">Click card mata pelajaran untuk mengisi report
                                            </p>
                                            <hr>
                                        </div>
                                            ...
                                            <div class="select-custom">
                                                ...
                                                <select id="kelas" class="form-control">
                                                    ...
                                                    <option value="<?php echo $kelas['id_kelas']; ?>"
                                                        <?php if ($kelas['id_kelas'] == $id_kelas)
                                                                                                                echo 'selected'; ?>>
                                        ...
                                        <tbody>
                                            ...
                                            if ($result && mysqli_num_rows($result) > 0) {
                                                ...
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    echo "<a href='#' onclick='checkAndRedirect(\"{$id_kelas}\", \"{$jenjang}\", \"{$semester}\", \"{$row['id_siswa']}\", \"{$id_tahun_ajar}\")' class='btn btn-primary btn-sm'>Lihat Repot</a>";
                                                    echo "</td>";
                                                    echo "</tr>";
    ...
    function reloadPageWithSelection() {
        ...
        window.location.href =
            `siswa_data_repot.php?id_kelas=${id_kelas}&jenjang=${jenjang}&semester=${semester}&type_nilai=<?php echo $type_nilai; ?>&id_tahun_ajar=${id_tahun_ajar}`;
    }
    ...
    function checkAndRedirect(id_kelas, jenjang, semester, id_siswa, id_tahun_ajar) {
        ...
        if (!tahun_ajar) {
            ...
            // Redirect to detail_repot page if all fields are selected
            var url =
                `detail_repot.php?id_kelas=${id_kelas}&jenjang=${jenjang}&semester=${semester}&id_siswa=${id_siswa}&id_tahun_ajar=${id_tahun_ajar}`;

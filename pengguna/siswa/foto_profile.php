                                ...
                                <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                                    <div class="photo">
                                        ...
                                        ?>
                                                    ...
                                                    <?php endif; ?>
                                                    <h5 class="title"><?php echo $siswa['username']; ?></h5>
                                    </div>
                            ...
                            <div class="card-body">
                                ...
                                <div class="author">
                                    ...
                                    <a href="javascript:void(0)" onclick="document.getElementById('editFotoProfile').click()">
                                        ...
                                        <?php endif; ?>
                                        <h5 class="title"><?php echo $siswa['nama']; ?></h5>
                                    </a>
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form id="editDataFp">
                                    <div class="row">
                                        <input type="hidden" class="form-control" name="id_siswa" id="id_siswa" value="<?php echo $siswa['id_siswa']; ?>">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Nama</label>
                                                <input type="text" class="form-control" placeholder="Nama" name="nama" id="nama" value="<?php echo $siswa['nama']; ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Username</label>
                                                <input type="text" class="form-control" placeholder="Username" name="username" id="username" value="<?php echo $siswa['username']; ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Password</label>
                                                <input type="text" class="form-control" placeholder="Password" name="password" id="password" value="<?php echo $siswa['password']; ?>">
                                            </div>
                                        </div>
                                    </div>

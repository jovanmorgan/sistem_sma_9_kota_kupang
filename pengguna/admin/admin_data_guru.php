...
<body class="white-content" translate="no">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_tambah" action="guru/tambah.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" class="form-control" id="jenjang" name="jenjang"
                                        value="<?php echo $jenjang; ?>" required>
                                    <input type="text" class="form-control" value="<?php echo $jenjang; ?>" required
                                        disabled>
                                </div>
                                <div class="form-group">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_edit" action="guru/edit.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="hidden" class="form-control" id="editjenjang" name="jenjang" required>
                                    <input type="text" class="form-control" value="<?php echo $jenjang; ?>" required
                                        disabled>
                                </div>
                                <div class="form-group">
    ...
    function loadTable() {
        ...
        xhrTable.open('GET', 'guru/load_table.php?jenjang=<?php echo $jenjang; ?>', true);
        xhrTable.send();
    }
    </script>

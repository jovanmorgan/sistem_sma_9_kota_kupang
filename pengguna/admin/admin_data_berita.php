                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_tambah" action="berita/tambah.php" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" placeholder="Silakan masukan judul"
                                        id="judul" name="judul" required>
                                </div>
                                <div class="form-group">
                                    <label for="isi_kegiatan">Kegiatan:</label>
                                    <textarea class="form-control" id="isi_kegiatan" name="isi_kegiatan"
                                        required></textarea>
                                </div>
                                <div class="form-group">
                                    <label for="kover">Data Foto:</label>
                                    <input type="file" class="form-control-file d-none" id="kover" name="foto"
                                        onchange="previewImage(this, 'koverPreview')" accept="image/*">
                                    <label class="btn btn-primary" for="kover">Pilih Foto</label>
                                </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_edit" action="berita/edit.php" method="POST" enctype="multipart/form-data">
                                <!-- Menambahkan input tersembunyi untuk menyimpan id_video saat mengedit -->
                                <input type="hidden" id="editid_berita" name="id_berita">
                                <div class="form-group">
                                    <label for="tanggal">Tanggal:</label>
                                ...
                                <div class="form-group">
                                    <label for="judul">Judul:</label>
                                    <input type="text" class="form-control" placeholder="Silakan masukan judul"
                                        id="editjudul" name="judul" required>
                                </div>
                                <div class="form-group">
                                    <label for="isi_kegiatan">Kegiatan:</label>
                                    <textarea class="form-control" id="editisi_kegiatan" name="isi_kegiatan"
                                        required></textarea>
                                </div>
                                <!-- Data Kover -->
                                <div class="form-group">
                                ...
                                <!-- js edit -->
                                <script>
                                function openEditModal(id_berita, tanggal, judul, isi_kegiatan, foto) {
                                    data_text = isi_kegiatan.replace(/<br\s*\/?>/gi, '\n');
                                    // Isi data ke dalam form edit
                                    document.getElementById('editid_berita').value = id_berita;
                                    document.getElementById('edittanggal').value = tanggal;
                                    document.getElementById('editjudul').value = judul;
                                    document.getElementById('editisi_kegiatan').value = data_text;

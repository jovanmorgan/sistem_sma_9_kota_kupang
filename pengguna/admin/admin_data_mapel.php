...
<body class="white-content" translate="no">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_edit" action="mapel/edit.php" method="POST" enctype="multipart/form-data">
                                <!-- Menambahkan input tersembunyi untuk menyimpan id_video saat mengedit -->
                                <input type="hidden" id="editid_mapel" name="id_mapel">
                                <div class="form-group">
                                    <label for="nama_mapel">mapel:</label>
                                    <input type="text" class="form-control" placeholder="Silakan masukan mapel"
                                        id="editnama_mapel" name="nama_mapel" required>
                                </div>
                                <script>
                                function openEditModal(id, mapel) {
                                    // Isi data ke dalam form edit
                                    document.getElementById('editid_mapel').value = id;
                                    document.getElementById('editnama_mapel').value = mapel;
    ...
    document.addEventListener('DOMContentLoaded', function() {
        document.getElementById('form_tambah').addEventListener('submit', function(event) {
            ...
            xhr.open('POST', 'mapel/tambah.php', true);
            xhr.onload = function() {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        document.getElementById('form_edit').addEventListener('submit', function(event) {
            ...
            var xhr = new XMLHttpRequest();
            xhr.open('POST', 'mapel/edit.php', true);
            xhr.onload = function() {
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    xhr.open('POST', 'mapel/hapus.php', true);
    ...
    function loadTable() {
        ...
        xhrTable.open('GET', 'mapel/load_table.php', true);
        xhrTable.send();
    }
    </script>

...
<body class="white-content" translate="no">
        ...
        <div class="main-panel">
            ...
            <div class="modal fade" id="modalTambah" tabindex="-1" role="dialog" aria-labelledby="modalTambahGuruLabel"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        <div class="modal-header">
                            <h5 class="modal-title" id="editModalLabel" style="font-size: 150%;">Tambah Data</h5>
                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_tambah" action="tahun_ajar/tambah.php" method="POST"
                                enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="tahun_ajar_awal">Data Tahun Ajaran Awal:</label>
                                    <input type="text" class="form-control"
                                        placeholder="Silakan masukan data tahun awal" id="tahun_ajar_awal"
                                        name="tahun_ajar_awal" required>
                                </div>
                                <div class="form-group">
                                    <label for="tahun_ajar_akhir">Data Tahun Ajaran Akhir:</label>
                                    <input type="text" class="form-control"
                                        placeholder="Silakan masukan data tahun akhir" id="tahun_ajar_akhir"
                                        name="tahun_ajar_akhir" required>
                                </div>
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_edit" action="tahun_ajar/edit.php" method="POST"
                                enctype="multipart/form-data">
                                <!-- Menambahkan input tersembunyi untuk menyimpan id_video saat mengedit -->
                                <input type="hidden" id="edit-id_tahun_ajar" name="id_tahun_ajar">
                                <div class="form-group">
                                    <label for="tahun_ajar_awal">Data Tahun Ajaran Awal:</label>
                                    <input type="text" class="form-control"
                                        placeholder="Silakan masukan data tahun awal" id="edit-tahun_ajar_awal"
                                        name="tahun_ajar_awal" required>
                                </div>
                                <div class="form-group">
                                    <label for="tahun_ajar_akhir">Data Tahun Ajaran Akhir:</label>
                                    <input type="text" class="form-control"
                                        placeholder="Silakan masukan data tahun akhir" id="edit-tahun_ajar_akhir"
                                        name="tahun_ajar_akhir" required>
                                </div>
                                <script>
                                function openEditModal(id, tahun_ajar_awal, tahun_ajar_akhir) {
                                    // Isi data ke dalam form edit
                                    document.getElementById('edit-id_tahun_ajar').value = id;
                                    document.getElementById('edit-tahun_ajar_awal').value = tahun_ajar_awal;
                                    document.getElementById('edit-tahun_ajar_akhir').value = tahun_ajar_akhir;
                                ...
                                <div class="table-responsive">
                                    <table class="table tablesorter " id="dataTable">
                                        ...
                                        <tbody>
                                            ...
                                            $query .= " ORDER BY id_tahun_ajar DESC";
                                            $result = mysqli_query($koneksi, $query);
                                            ...
                                            if ($result) {
                                                ...
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    <button class='btn btn-primary btn-sm' onclick='openEditModal(
                                                        \"" . $row['id_tahun_ajar'] . "\",
                                                        \"" . $row['tahun_ajar_awal'] . "\",
                                                        \"" . $row['tahun_ajar_akhir'] . "\"
                                                    )'>Edit</button>
                                                       </td>";
                                                    echo "<td class='text-center'>
                                                    <button class='btn btn-danger btn-sm' onclick='hapus(\"" . $row['id_tahun_ajar'] . "\")'>Hapus</button>
                                                </td>";
    ...
    document.addEventListener('DOMContentLoaded', function() {
        document.getElementById('form_tambah').addEventListener('submit', function(event) {
            ...
            xhr.open('POST', 'tahun_ajar/tambah.php', true);
            xhr.onload = function() {
                ...
                if (xhr.status === 200) {
                    ...
                    } else if (response === 'tahun_ajar_awal_sudah_ada') {
                        swal("janis kebutuhan khusus Salah!",
                            "Data  sudah digunakan silakan gunakan tahun_ajar lain",
                            "error");
                    } else if (response === 'tahun_ajar_akhir_sudah_ada') {
                        swal("janis kebutuhan khusus Salah!",
                            "Data  sudah digunakan silakan gunakan tahun_ajar lain",
                            "error");
                    } else {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        document.getElementById('form_edit').addEventListener('submit', function(event) {
            ...
            var xhr = new XMLHttpRequest();
            xhr.open('POST', 'tahun_ajar/edit.php', true);
            xhr.onload = function() {
                ...
                if (xhr.status === 200) {
                    ...
                    if (response === 'success') {
                        ...
                        swal("Tahun Ajar Awal Salah!",
                            "Tahun Ajar  sudah digunakan silakan gunakan Tahun Ajar lain",
                            "error");
                    } else if (response === 'tahun_ajar_akhir_sudah_ada') {
                        swal("Tahun Ajar Akhir Salah!",
                            "Tahun Ajar sudah digunakan silakan gunakan Tahun Ajar lain",
                            "error");
                    } else {
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    xhr.open('POST', 'tahun_ajar/hapus.php', true);
    ...
    function loadTable() {
        ...
        xhrTable.open('GET', 'tahun_ajar/load_table.php', true);
        xhrTable.send();
    }
    </script>

...
<body class="white-content" translate="no">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_tambah" action="kebutuhan_khusus/tambah.php" method="POST"
                                enctype="multipart/form-data">
                                <div class="form-group">
                                    <label for="jenis_kebutuhan_khusus">Jenis Kebutuhan Khusus:</label>
                                    <input type="text" class="form-control" placeholder="Silakan masukan data"
                                        id="jenis_kebutuhan_khusus" name="jenis_kebutuhan_khusus" required>
                                </div>
                                <div class="form-group">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_edit" action="kebutuhan_khusus/edit.php" method="POST"
                                enctype="multipart/form-data">
                                <!-- Menambahkan input tersembunyi untuk menyimpan id_video saat mengedit -->
                                <input type="hidden" id="editid_kebutuhan_khusus" name="id_kebutuhan_khusus">
                                <div class="form-group">
                                    <label for="jenis_kebutuhan_khusus">Jenis Kebutuhan Khusus:</label>
                                    <input type="text" class="form-control" placeholder="Silakan masukan data"
                                        id="editjenis_kebutuhan_khusus" name="jenis_kebutuhan_khusus" required>
                                </div>
                                <div class="form-group">
                                    <label for="deskripsi">Deskripsi</label>
                                ...
                                <script>
                                function openEditModal(id, jenis, deskripsi) {
                                    // Isi data ke dalam form edit
                                    document.getElementById('editid_kebutuhan_khusus').value = id;
                                    document.getElementById('editjenis_kebutuhan_khusus').value = jenis;
                                    ...
                                    <table class="table tablesorter " id="dataTable">
                                        ...
                                        <tbody>
                                            ...
                                            if (!empty($search_query)) {
                                                $query .= " WHERE jenis_kebutuhan_khusus LIKE '%$search_query%' OR deskripsi LIKE '%$search_query%'";
                                            }
    ...
    document.addEventListener('DOMContentLoaded', function() {
        document.getElementById('form_tambah').addEventListener('submit', function(event) {
            ...
            xhr.open('POST', 'kebutuhan_khusus/tambah.php', true);
            xhr.onload = function() {
                ...
                if (xhr.status === 200) {
                    ...
                    if (response === 'success') {
                        ...
                        swal("janis kebutuhan khusus Salah!",
                            "Data  sudah digunakan silakan gunakan kebutuhan_khusus lain",
                            "error");
                    } else {
    ...
    document.addEventListener('DOMContentLoaded', function() {
        document.getElementById('form_edit').addEventListener('submit', function(event) {
            ...
            var xhr = new XMLHttpRequest();
            xhr.open('POST', 'kebutuhan_khusus/edit.php', true);
            xhr.onload = function() {
                ...
                if (xhr.status === 200) {
                    ...
                    if (response === 'success') {
                        ...
                        swal("Error", "Data edit yang anda masukan belum lengkap",
                            "error");
                    } else if (response === 'data_kebutuhan_khusus_sudah_ada') {
                        swal("kebutuhan_khusus Salah!",
                            "Data kebutuhan_khusus sudah digunakan silakan gunakan kebutuhan_khusus lain",
                            "error");
                    } else {
        ...
        swal({
            ...
            .then((willDelete) => {
                if (willDelete) {
                    ...
                    xhr.open('POST', 'kebutuhan_khusus/hapus.php', true);
    ...
    function loadTable() {
        ...
        xhrTable.open('GET', 'kebutuhan_khusus/load_table.php', true);
        xhrTable.send();
    }
    </script>

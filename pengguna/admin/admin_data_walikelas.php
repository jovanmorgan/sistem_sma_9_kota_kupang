...
<body class="white-content" translate="no">
                            ...
                            <form id="form_tambah" action="wali_kelas/tambah.php" method="POST"
                                ...
                                <div class="form-group">
                                    ...
                                    <select class="form-control" id="id_guru" name="id_guru" required>
                                        ...
                                        $query_guru = "SELECT id_guru, nama FROM guru WHERE jenjang = '$jenjang'";
                                ...
                                <div class="places-buttons">
                                    <div class="row">
                                        <div class="col-md-6 ml-auto mr-auto text-center">
                                            <h2 class="card-title">
                                                Data Walikelas <?php echo $jenjang; ?>
                                            </h2>

                                            <p class="category">Clik untuk menambah data walikelas
                                                <?php echo $jenjang; ?></p>
                                            <hr>
                                        </div>
                                    </div>
    ...
    function loadTable() {
        ...
        xhrTable.open('GET', 'wali_kelas/load_table.php?jenjang=<?php $jenjang; ?>', true);
        xhrTable.send();
    }
    </script>

...
$query = "INSERT INTO absensi2 (id_absensi1, id_guru, jam_mengajar, jam_pulang, hadir, sakit, ijin, alpa, tanggal) 
          VALUES ('$id_absensi1', '$id_guru', '$jam_mengajar', '$jam_pulang', '$hadir', '$sakit', '$ijin', '$alpa', '$tanggal_sekarang')";

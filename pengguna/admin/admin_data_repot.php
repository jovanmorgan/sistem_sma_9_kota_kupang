...
<body translate="no" class="white-content">
                                ...
                                <div class="places-buttons">
                                    <div class="row mb-3">
                                        <div class="col-md-12 ml-auto mr-auto text-center">
                                            ...
                                            <p class="category-custom">Clik mata pelajaran untuk mengisi Raport
                                            </p>
                                            <hr>
                                        </div>
                                    ...
                                    <table class="table tablesorter " id="dataTable">
                                        <thead class="text-primary">
                                            <tr>
                                                ...
                                                <th class="text-center" style="white-space: nowrap;">NIS </th>
                                                <th class="text-center" style="white-space: nowrap;">Nama</th>
                                                <th class="text-center" style="white-space: nowrap;">Lihat Raport</th>
                                                </th>
                                            </tr>
                                        </thead>
                                        <tbody>
    ...
    function reloadPageWithSelection() {
        ...
        window.location.href =
            `admin_data_repot.php?id_kelas=${id_kelas}&jenjang=${jenjang}&semester=${semester}&type_nilai=<?php echo $type_nilai; ?>&id_tahun_ajar=${id_tahun_ajar}`;
    }

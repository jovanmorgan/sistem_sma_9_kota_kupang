...
if (empty($id_wali_kelas) |empty($id_guru) || empty($id_kelas) || empty($username) || empty($password)) {
...
$check_query_wali_kelas = "SELECT * FROM wali_kelas WHERE username = '$username' AND id_wali_kelas != '$id_wali_kelas'";
...
$query_update = "UPDATE wali_kelas SET id_guru = '$id_guru', id_kelas = '$id_kelas', username = '$username', password = '$password' WHERE id_wali_kelas = '$id_wali_kelas'";

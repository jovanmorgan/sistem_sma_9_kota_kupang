                            ...
                            <li class="dropdown nav-item">
                                <a href="#" class="dropdown-toggle nav-link" data-toggle="dropdown">
                                    <div class="photo">
                                        ...
                                        <?php endif; ?>
                                        <h5 class="title"><?php echo $kepalah_sekolah['username']; ?></h5>
                                    </div>
                                ...
                                <ul class="dropdown-menu dropdown-navbar">
                                    <li class="nav-link active"><a href="foto_profile"
                            ...
                            <div class="card-body">
                                ...
                                <div class="author">
                                    ...
                                    <a href="javascript:void(0)"
                                        ...
                                        <?php endif; ?>
                                        <h5 class="title"><?php echo $kepalah_sekolah['nama']; ?></h5>
                                    </a>
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    ...
                                                    <button type="button" class="btn btn-primary"
                                                        id="btnSaveProfile">Save changes</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                    ...
                    <div class="col-md-8">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <form id="editDataFp">
                                    <div class="row">
                                        <input type="hidden" class="form-control" name="id_kepalah_sekolah"
                                            id="id_kepalah_sekolah"
                                            value="<?php echo $kepalah_sekolah['id_kepalah_sekolah']; ?>">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                <label>Nama</label>
                                                <input type="text" class="form-control" placeholder="Nama" name="nama"
                                                    id="nama" value="<?php echo $kepalah_sekolah['nama']; ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Username"
                                                    ...
                                                    value="<?php echo $kepalah_sekolah['username']; ?>">
                                            </div>
                                        </div>
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Password"
                                                    ...
                                                    value="<?php echo $kepalah_sekolah['password']; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="card-footer d-flex justify-content-end">
                                        <button type="submit" class="btn btn-fill btn-primary"
                                            id="editDataFp">Save</button>
                                    </div>
                                </form>
                            </div>
                        </div>

...
$query_update = "UPDATE guru SET nama = '$nama', nip = '$nip', jenis_kelamin = '$jenis_kelamin', nomor_telepon = '$nomor_telepon', username = '$username', password = '$password',  alamat = '$alamat', jenjang = '$jenjang' WHERE id_guru = '$id_guru'";

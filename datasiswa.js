...
function nextData() {
    if (currentDataIndex < dataSiswa.length - 1) {
        currentDataIndex++;
    } else {
        currentDataIndex = 0;
    }
...
function displayData() {
    ...
    newRow.innerHTML = `
            <td><img src="${dataGuru[currentDataIndex].foto}" alt="Foto Siswa"></td>
            <td>${dataSiswa[currentDataIndex].nama}</td>
            <td>${dataSiswa[currentDataIndex].nip}</td>
            <td>${dataSiswa[currentDataIndex].alamat}</td>
            <td>${dataSiswa[currentDataIndex].telepon}</td>
        `;
}

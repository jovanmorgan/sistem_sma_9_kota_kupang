...
<body>
    ...
    <div class="hero-section">
        ...
        <div class="container">
            <h1>AKADEMIK SLBN KOTA KUPANG</h1>
            <h5>Silakan login untuk melihat data akademik!</h5>
            <!-- Tombol login dengan tampilan yang diberikan oleh CSS -->
            <div class="d-flex justify-content-center mt-4">
                <a href="login" class="login-button">Login</a>
            </div>
            <!-- Tambahkan ikon panah ke bawah untuk mengarahkan ke konten ke-2 -->
            <div class="d-flex justify-content-center mt-4 kebawa">
                <a href="#konten2" onclick="slowScroll()">
                    <img style="position: relative; top: 42px;" src="img/dropdown-arrow.png" width="56" height="56"
    ...
    <!-- Konten ke 2-->
    <div id="konten2" class="container-xxl mt-2 mb-1 bg-light" style="padding-bottom: 120px;">
        <h2 class="atas-content" style="font-size: 25px; font-weight: bolder; text-align: center; padding-top: 200px;">
            Kepala Sekolah SLBN Kota Kupang</h2>
        <div class="row bagian2">
            <div class="col-md-3">
                <!-- Gambar bulat di kiri -->
                <div class="left-content text-center mb-5 ">
                    <img src="img/Kepala Sekolah1.JPG" alt="Gambar"
                        style="width: 250px; height: 250px; border-radius: 50%" />
                    <h3 style="font-size: 17px; padding-top: 12px;">Mujriyah.spd</h3>
                </div>
            </div>
            <div class="col-md-6 text-center mb-5">
                <!-- Teks di tengah -->
                <div class="center-content">
                    <h2 style="font-size: 25px; padding-top: 20px;">Kata sambutan</h2>
                    <p style="text-align: justify; font-weight: no;">
                        "Tentram sejahtera, Selamat datang di website resmi SLBN Kota Kupang. Kami
                        dengan senang hati
                        menyambut Anda dalam perjalanan digital ini. Di sini, Anda akan menemukan
                        beragam informasi dan
                        kegiatan yang kami sajikan dengan harapan dapat memberikan wawasan
                        dan inspirasi baru. Terima kasih atas kunjungan Anda, semoga pengalaman
                        menjelajah di website
                        ini memberikan manfaat yang berarti bagi Anda. Salam hormat dari Kepala Sekolah
                        dan seluruh staf
                        SLBN Kota Kupang."
                    </p>
                </div>
            ...
            <div class="col-md-3">
                <!-- Kalender di kanan -->
                <div class="right-content" id="calendar"></div>
            </div>
        </div>
    </div>
    </div>

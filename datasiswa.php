...
<body>
    ...
    <nav id="navbar" class="navbar navbar-expand-lg navbar-light bg-light">
        <div class="container-fluid">
            <a class="navbar-brand" href="#" style="position: relative; top: -10px"><img src="img/gif-unscreen.gif" style="height: 50px; width: auto; position: relative; top: 5px" />SLBN KOTA KUPANG</a>
            <p style="
            position: relative;
            top: 15px;
            right: 195px;
                ...
                <ul class="navbar-nav">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                            ...
                            <li>
                                <a class="dropdown-item" href="datamapel">Data Mapel Pelajaran</a>
                            </li>
                        </ul>
                    </li>
                    <li class="nav-item">
    ...
    <!-- Konten ke 2-->
    <div id="konten2" class="container mt-2 mb-1 bg-light">
        <h2 class="garistitik text-center py-4">
            -------------------
        </h2>
        <div class="row justify-content-center bagian2">
            <div class="col-md-10">
                <!-- Teks di kiri -->
                <h2 class="text-center mb-4">SISWA & SISWI SLBN KOTA KUPANG | Kelapa Lima</h2>
                <div class="table-responsive">
                    <table class="table table-bordered table-striped">
                        ...
                        <tbody>
                            <!-- Data Siswa -->
                            <tr>
                                <td><img src="foto_siswa1.jpg" alt="Foto Siswa"></td>
                                <td>John Doe</td>
                                <td>1234567890</td>
                                <td>X</td>
                                <td>SMA</td>
                            ...
                            <tr>
                                <td><img src="foto_siswa2.jpg" alt="Foto Siswa"></td>
                                <td>Jane Doe</td>
                                <td>0987654321</td>
                                <td>XII</td>
                                <td>SMA</td>
                            ...
                            <!-- Tambahkan baris siswa lainnya di sini -->
                        </tbody>
                    </table>
                </div>
